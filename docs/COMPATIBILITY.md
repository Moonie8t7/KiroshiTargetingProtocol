...
| Codeware | Optional | The NPC spawn hook falls back from the `Entity/Attach` CallbackSystem path to `@wrapMethod(ScriptedPuppet) OnGameAttached`. The two are equivalent for this purpose |
